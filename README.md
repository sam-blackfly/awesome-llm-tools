...
| [agent-model-switch-guard](https://github.com/wd041216-bit/agent-model-switch-guard) | Tiny runtime-state helpers that separate selected model from active runtime model so agents stop falsely claiming a switch already happened | ![Stars](https://img.shields.io/github/stars/wd041216-bit/agent-model-switch-guard?style=flat-square) | MIT |
